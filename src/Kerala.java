...
public class Kerala extends JFrame {
	...
	private String images[] = {"kerala5.jpg","kerala1.jpg","kerala2.jpeg","kerala3.jpg","kerala4.jpg"};
	private int i = 0;
	...
	public final float price = 22000f;
	...
	public Kerala() {
		...
		JLabel lblNewLabel = new JLabel("Kerala\r\n\r\n");
		...
		JButton btnNewButton_1 = new JButton("Book Now @22,000/ per head");
		...
		btnNewButton_1.setActionCommand("Kerala");
		...
		lblNewLabel_1.setIcon(new ImageIcon(Kerala.class.getResource("/resources/"+images[i])));
