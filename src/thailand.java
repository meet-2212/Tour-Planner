...
public class thailand extends JFrame {
	...
	private String images[] = {"thailand1.jpg","thailand2.jpg","thailand3.jpg","thailand4.jpg","thailand5.jpg"}; 
	private int i = 0;
	public String selected;
	public final float price = 38500f;
	...
	public thailand() {
		setVisible(true);
		setTitle("Tour-Planner -- Thailand"); 
		...
		JLabel lblNewLabel = new JLabel("Thailand");
		...
		JButton btnNewButton_1 = new JButton("Book Now @38,500/ per head");
		btnNewButton_1.setActionCommand("Thailand");
		...
		txtdnIncTravel.setText("8D,8N inc. Travel\r\n");
		...
		txtAirport.setText("30/05/21 Airport\r\n");
		...
		lblNewLabel_1.setIcon(new ImageIcon(thailand.class.getResource("/resources/"+images[i])));
