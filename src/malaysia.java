...
public class malaysia extends JFrame {
	...
	private String images[] = {"malasiya1.jpg","malasiya2.jpg","malasiya3.jpg","malasiya4.jpg","malasiya5.jpg"};
	private int i = 0;
	...
	public final float price = 40000f;
	
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					malaysia frame = new malaysia();
	...
	public malaysia() {
		setVisible(true);
		setTitle("Tour-Planner -- Malaysia"); 
		...
		JLabel lblNewLabel = new JLabel("Malaysia");
		...
		JButton btnNewButton_1 = new JButton("Book Now @40,000/ per head");
		btnNewButton_1.setActionCommand("Malaysia");
		...
		lblNewLabel_1.setIcon(new ImageIcon(malaysia.class.getResource("/resources/"+images[i])));
