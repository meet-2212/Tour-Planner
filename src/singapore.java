...
public class singapore extends JFrame {

	private JPanel contentPane;
	private String images[] = {"singapore1.jpg","singapore2.jpg","singapore3.jpg","singapore4.jpg","singapore5.jfif"};
	private int i = 0;
	...
	public final float price = 30000f;
	...
	public singapore() {
		setVisible(true);
		setTitle("Tour-Planner -- Singapore"); 
		...
		JLabel lblNewLabel = new JLabel("Singapore");
		lblNewLabel.setForeground(new Color(255, 255, 255));
		lblNewLabel.setFont(new Font("Tahoma", Font.PLAIN, 24));
		lblNewLabel.setBounds(631, 10, 217, 38);
		...
		JButton btnNewButton_1 = new JButton("Book Now @30,000/ per head");
		btnNewButton_1.setActionCommand("Singapore");
		...
		txtdnIncTravel.setText("5D,5N inc. Travel\r\n");
		...
		lblNewLabel_1.setIcon(new ImageIcon(singapore.class.getResource("/resources/"+images[i])));
