...
public class JK extends JFrame {
	...
	private String images[] = {"jammu1.jpg","jammu2.jpg","jammu3.jpg","jammu4.jpg","jammu5.jpg"};
	private int i = 0;
	...
	public final float price = 19000f;
	...
	public JK() {
		setVisible(true);
		setTitle("Tour-Planner -- Jammu & Kashmir"); 
		...
		JLabel lblNewLabel = new JLabel("Jammu & Kashmir");
		...
		JButton btnNewButton_1 = new JButton("Book Now @19,000/ per head");
		btnNewButton_1.setActionCommand("Jammu & Kashmir");
		...
		txtAirport_1.setText("20/05/21 Airport");
		...
		txtAirport.setText("28/05/21 Airport\r\n");
		...
		lblNewLabel_1.setIcon(new ImageIcon(JK.class.getResource("/resources/"+images[i])));
